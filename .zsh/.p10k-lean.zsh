...
() {
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}%F{yellow} ${VCS_STATUS_STASHES}"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=247
  ...
  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=011
  # Custom icon.
